...
BOARD_SUPER_PARTITION_GROUPS := nokia_sdm660_dynamic_partitions
BOARD_NOKIA_SDM660_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_NOKIA_SDM660_DYNAMIC_PARTITIONS_LIST := system vendor
